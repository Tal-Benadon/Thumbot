...
# TODO: Handle instagram's categorized_formats to take in all formats within filtered_formats,
# priorities 720, but just use integer comparison to go lower within the resolutions 
# (available resolutions may be more than what resolution_priority suggests)
